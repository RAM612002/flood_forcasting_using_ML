...
uploadButton.place(x=400, y=550)
uploadButton.config(font=font1)

pathlabel = Label(main)
pathlabel.config(bg='DarkOrange1', fg='white')
pathlabel.config(font=font1)
pathlabel.place(x=650, y=550)
...
open_second_button.place(x=400, y=620)
...
open_second_button.place(x=650, y=620)
open_second_button.config(font=font1)
...
splitButton.place(x=1250, y=620)
splitButton.config(font=font1)
...
show_results_button.place(x=650, y=700)
...
open_second_button.place(x=1250, y=700)
open_second_button.config(font=font1)
...
open_second_button.place(x=650, y=800)
open_second_button.config(font=font1)
